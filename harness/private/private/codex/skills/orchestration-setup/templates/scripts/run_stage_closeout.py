    ...
    with stage_closeout_lock(repo_root, stage_id):
        ...
        if evidence_config is not None:
            ...
            automatic_reuse = bool(
                reuse_policy_enabled and not args.must_run and not args.shadow
            )
            ...
            try:
                report = run_verification(
                    ...
                    reuse_requested=args.reuse or automatic_reuse,
                    must_run=args.must_run
                    or (not args.reuse and not automatic_reuse and not args.shadow),
                    shadow=args.shadow,
