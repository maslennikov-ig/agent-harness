...
- Medium/complex, staged, risky, or handoff-prone work uses
  `orchestrator-stage`.
- Reuse trusted installed assets; do not auto-promote unvetted ones.
- With GPT-6 Astra as lead, act primarily as orchestrator. Start with Sol for
  complex delegated work, Terra for simpler work, and Luna for mechanical
  work; choose the least costly capable option. The stage skill owns native
  model/effort controls and fallbacks.
