Use $orchestrator-stage for a cross-model review.

Target: ChatGPT/Codex GPT-6 Astra
Audience: independent auditor of work completed by Claude Opus 5.
...
Stop: for the report turn, before edits, commits, push/merge/deploy, deletion, external messages, paid calls, or wider scope. After the answer, follow the chosen path and its authority boundaries.
